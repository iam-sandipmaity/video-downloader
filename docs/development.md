...
at [../.github/workflows/crowdin.yml](../.github/workflows/crowdin.yml). It
uploads the base Android XML strings file and downloads translated Android XML
back into the matching `values-<locale>` resource folder.
