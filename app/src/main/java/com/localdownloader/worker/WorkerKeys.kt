...
object WorkerKeys {
    ...
    const val SUBTITLE_LANGUAGES = "subtitle_languages"
    const val AUTO_SUBTITLES = "auto_subtitles"
    const val AUTO_TRANSLATED_SUBTITLES = "auto_translated_subtitles"
    const val SUBTITLE_CONVERT_FORMAT = "subtitle_convert_format"
    const val KEEP_SUBTITLE_FILES = "keep_subtitle_files"
